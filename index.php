...
<body>
    <div id="alerr"
        style="background:rgba(51,51,51,0.8); color:#FFF; min-height:100px; width:300px; position:fixed; display:none; z-index:9999; overflow:auto;left:50%;top:50%;height:50%">
        <pre id="ssaa"></pre>
    </div>
    <div id="all">
        <div id="title">
            <?=date("m 月 d 號 l")?> | 今日瀏覽: <?=$_SESSION['visited']?> | 累積瀏覽:  <?=$Visited->q("select sum(`visited`) from `visited`")[0][0]?>
